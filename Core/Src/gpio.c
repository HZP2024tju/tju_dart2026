...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : GndPIN_Pin */
  GPIO_InitStruct.Pin = GndPIN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GndPIN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : VccPIN_Pin vccpin_Pin */
  GPIO_InitStruct.Pin = VccPIN_Pin|vccpin_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
